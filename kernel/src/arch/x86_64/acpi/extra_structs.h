...
enum acpi_hpet_event_timer_block_id_shifts {
    HPET_EVENTTIMER_BLOCKID_COMPARATOR_NUM_1ST_TIMER_SHIFT = 8,
    HPET_EVENTTIMER_BLOCKID_1ST_TIMER_PCI_VENDOR_ID_SHIFT = 32,
};

enum acpi_hpet_event_timer_block_id_flags {
    __HPET_EVENTTIMER_BLOCKID_HW_REV_ID = 0xFF,
    __HPET_EVENTTIMER_BLOCKID_COMPARATOR_NUM_1ST_TIMER =
        0b1111 << HPET_EVENTTIMER_BLOCKID_COMPARATOR_NUM_1ST_TIMER_SHIFT,
    ...
    __HPET_EVENTTIMER_BLOCKID_1ST_TIMER_PCI_VENDOR_ID =
        0xFFFFFFFFull << HPET_EVENTTIMER_BLOCKID_1ST_TIMER_PCI_VENDOR_ID_SHIFT
};
