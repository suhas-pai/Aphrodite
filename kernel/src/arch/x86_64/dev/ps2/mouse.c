...
static const struct string_view pnp_ids[] = {
    SV_STATIC("PNP0F00"), SV_STATIC("PNP0F01"), SV_STATIC("PNP0F02"),
    SV_STATIC("PNP0F03"), SV_STATIC("PNP0F04"), SV_STATIC("PNP0F05"),
    SV_STATIC("PNP0F06"), SV_STATIC("PNP0F07"), SV_STATIC("PNP0F08"),
    SV_STATIC("PNP0F09"), SV_STATIC("PNP0F0A"), SV_STATIC("PNP0F0B"),
    SV_STATIC("PNP0F0C"), SV_STATIC("PNP0F0D"), SV_STATIC("PNP0F0E"),
    SV_STATIC("PNP0F0F"), SV_STATIC("PNP0F10"), SV_STATIC("PNP0F11"),
    SV_STATIC("PNP0F12"), SV_STATIC("PNP0F13"), SV_STATIC("PNP0F14"),
    SV_STATIC("PNP0F15"), SV_STATIC("PNP0F16"), SV_STATIC("PNP0F17"),
    SV_STATIC("PNP0F18"), SV_STATIC("PNP0F19"), SV_STATIC("PNP0F1A"),
    SV_STATIC("PNP0F1B"), SV_STATIC("PNP0F1C"), SV_STATIC("PNP0F1D"),
    SV_STATIC("PNP0F1E"), SV_STATIC("PNP0F1F"), SV_STATIC("PNP0F20"),
    SV_STATIC("PNP0F21"), SV_STATIC("PNP0F22"), SV_STATIC("PNP0F23"),
