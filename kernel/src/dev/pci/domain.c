...
bool pci_add_domain(struct pci_domain *const domain) {
...
bool pci_remove_domain(struct pci_domain *const domain) {
    uint32_t index = 0;
    const int flag = spin_acquire_with_irq(&g_domain_lock);
...
const struct array *pci_get_domain_list_locked(int *const flag_out) {
    *flag_out = spin_acquire_with_irq(&g_domain_lock);
    return &g_domain_list;
}

void pci_release_domain_list_lock(const int flag) {
    spin_release_with_irq(&g_domain_lock, flag);
}

__optimize(3) uint8_t
pci_domain_read_8(struct pci_domain *const obj,
                  ...
                  const uint16_t offset)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            return pci_ecam_read_8((struct pci_ecam_domain *)obj, loc, offset);
    }
...
pci_domain_read_16(struct pci_domain *const obj,
                   const struct pci_location *const loc,
                   const uint16_t offset)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            return pci_ecam_read_16((struct pci_ecam_domain *)obj, loc, offset);
    }
...
pci_domain_read_32(struct pci_domain *const obj,
                   const struct pci_location *const loc,
                   const uint16_t offset)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            return pci_ecam_read_32((struct pci_ecam_domain *)obj, loc, offset);
    }
...
pci_domain_read_64(struct pci_domain *const obj,
                   const struct pci_location *const loc,
                   const uint16_t offset)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            return pci_ecam_read_64((struct pci_ecam_domain *)obj, loc, offset);
    }
...
__optimize(3) void
pci_domain_write_8(struct pci_domain *const obj,
                   const struct pci_location *const loc,
                   const uint16_t offset,
                   const uint8_t value)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            pci_ecam_write_8((struct pci_ecam_domain *)obj, loc, offset, value);
            return;
    }
...
__optimize(3) void
pci_domain_write_16(struct pci_domain *const obj,
                    const struct pci_location *const loc,
                    const uint16_t offset,
                    const uint16_t value)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            pci_ecam_write_16((struct pci_ecam_domain *)obj,
                              loc,
                              offset,
                              value);
            return;
...
__optimize(3) void
pci_domain_write_32(struct pci_domain *const obj,
                    const struct pci_location *const loc,
                    const uint16_t offset,
                    const uint32_t value)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            pci_ecam_write_32((struct pci_ecam_domain *)obj,
                              loc,
                              offset,
                              value);
            return;
...
__optimize(3) void
pci_domain_write_64(struct pci_domain *const obj,
                    const struct pci_location *const loc,
                    const uint16_t offset,
                    const uint64_t value)
{
    switch (obj->kind) {
        ...
        case PCI_DOMAIN_ECAM:
            pci_ecam_write_64((struct pci_ecam_domain *)obj,
                              loc,
                              offset,
                              value);
            return;
