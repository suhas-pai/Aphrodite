/*
 * kernel/include/arch/x86_64/dev/ps2/driver.h
 * © suhas pai
 */
...
enum ps2_test_controller_result : uint8_t {
    E_PS2_TEST_CNTRLR_OK = 0x55,
    E_PS2_TEST_CNTRLR_FAILED = PS2_RESPONSE_FAIL,
};

enum ps2_test_port_result : uint8_t {
    E_PS2_TEST_PORT_OK,
};

enum ps2_controller_config_byte_masks : uint8_t {
...
enum ps2_status_register_masks : uint8_t {
