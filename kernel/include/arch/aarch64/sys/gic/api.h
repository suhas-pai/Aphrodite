...
#define GIC_SGI_INTR_START 0
#define GIC_SGI_INTR_LAST 15

#define GIC_SGI_INTR_RANGE \
    RANGE_INIT(GIC_SGI_INTR_START, (GIC_SGI_INTR_LAST - GIC_SGI_INTR_LAST) + 1)

#define GIC_PPI_INTR_START 16
#define GIC_PPI_INTR_LAST 31

#define GIC_PPI_INTR_RANGE \
    RANGE_INIT(GIC_PPI_INTR_START, (GIC_PPI_INTR_LAST - GIC_PPI_INTR_LAST) + 1)

#define GIC_SPI_INTR_START 32
#define GIC_SPI_INTR_LAST 1020

#define GIC_SPI_INTR_RANGE \
    RANGE_INIT(GIC_SPI_INTR_START, (GIC_SPI_INTR_LAST - GIC_SPI_INTR_LAST) + 1)
