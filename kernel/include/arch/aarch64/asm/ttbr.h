/*
 * kernel/include/arch/aarch64/asm/ttbr.h
 * © suhas pai
 */
...
__debug_optimize(3) static inline uint64_t read_ttbr0_el1() {
    uint64_t value = 0;
...
__debug_optimize(3) static inline uint64_t read_ttbr1_el1() {
    uint64_t value = 0;
