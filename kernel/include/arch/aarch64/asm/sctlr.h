/*
 * kernel/include/arch/aarch64/asm/sctlr.h
 * © suhas pai
 */
...
__debug_optimize(3) static inline uint64_t read_sctlr_el1() {
    uint64_t result = 0;
...
__debug_optimize(3) static inline void write_sctlr_el0(const uint64_t value) {
    asm volatile ("msr sctlr_el0, %0" :: "r"(value));
}

__debug_optimize(3) static inline void write_sctlr_el1(const uint64_t value) {
