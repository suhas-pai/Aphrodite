...
enum nvme_command_opcode : uint8_t {
    ...
    NVME_CMD_ADMIN_OPCODE_DELETE_SQ = 0,
    NVME_CMD_ADMIN_OPCODE_CREATE_SQ = 1,

    NVME_CMD_ADMIN_OPCODE_GET_LOG_PAGE,

    NVME_CMD_ADMIN_OPCODE_DELETE_CQ = 4,
    NVME_CMD_ADMIN_OPCODE_CREATE_CQ,

    NVME_CMD_ADMIN_OPCODE_IDENTIFY,
    NVME_CMD_ADMIN_OPCODE_ABORT = 8,

    NVME_CMD_ADMIN_OPCODE_SET_FEATURES,
    NVME_CMD_ADMIN_OPCODE_GET_FEATURES,

    NVME_CMD_ADMIN_OPCODE_ASYNC_EVENT_REQUEST = 0xC,
    NVME_CMD_ADMIN_OPCODE_NAMESPACE_MANAGEMENT,

    NVME_CMD_ADMIN_OPCODE_FIRMWARE_COMMIT = 0x10,
    NVME_CMD_ADMIN_OPCODE_FIRMWARE_IMAGE_DOWNLOAD,
    NVME_CMD_ADMIN_OPCODE_DEVICE_SELF_TEST = 0x14,

    NVME_CMD_ADMIN_OPCODE_NAMESPACE_ATTACHMENT,
    NVME_CMD_ADMIN_OPCODE_KEEP_ALIVE = 0x18,

    NVME_CMD_ADMIN_OPCODE_DIRECTIVE_SEND,
    NVME_CMD_ADMIN_OPCODE_DIRECTIVE_RECEIVE,

    NVME_CMD_ADMIN_OPCODE_VIRTUALIZATION_MANAGEMENT = 0x1C,

    NVME_CMD_ADMIN_OPCODE_MI_SEND,
    NVME_CMD_ADMIN_OPCODE_MI_RECEIVE,

    NVME_CMD_ADMIN_OPCODE_CAPACITY_MANAGEMENT = 0x20,
    NVME_CMD_ADMIN_OPCODE_DISCOVERY_INFO_MANAGEMENT,
    NVME_CMD_ADMIN_OPCODE_FABRIC_ZONING_RECEIVE,

    NVME_CMD_ADMIN_OPCODE_LOCKDOWN = 0x24,
    NVME_CMD_ADMIN_OPCODE_FABRIC_ZONING_LOOKUP,

    NVME_CMD_ADMIN_OPCODE_CLEAR_EXPORTED_NVM_RESOURCE_CONFIG = 0x28,
    NVME_CMD_ADMIN_OPCODE_FABRIC_ZONING_SEND,

    NVME_CMD_ADMIN_OPCODE_CREATE_EXPORTED_NVM_RESOURCE_CONFIG,
    NVME_CMD_ADMIN_OPCODE_MANAGE_EXPORTED_NVM_RESOURCE_CONFIG = 0x2D,

    NVME_CMD_ADMIN_OPCODE_MANAGE_EXPORTED_NAMESPACE = 0x31,
    NVME_CMD_ADMIN_OPCODE_MANAGE_EXPORTED_PORT = 0x35,
    NVME_CMD_ADMIN_OPCODE_SEND_DISCOVERY_LOG_PAGE = 0x39,

    NVME_CMD_ADMIN_OPCODE_TRACK_SEND = 0x3D,
    NVME_CMD_ADMIN_OPCODE_TRACK_RECEIVE,

    NVME_CMD_ADMIN_OPCODE_MIGRATION_SEND = 0x41,
    NVME_CMD_ADMIN_OPCODE_MIGRATION_RECEIVE,

    NVME_CMD_ADMIN_OPCODE_CONTROLLER_DATA_QUEUE = 0x45,
    NVME_CMD_ADMIN_OPCODE_DOORBELL_BUFFER_CONFIG = 0x7C,

    NVME_CMD_ADMIN_OPCODE_FABRIC_COMMAND = 0x7F,
    NVME_CMD_ADMIN_OPCODE_FORMAT_NVM = 0x80,

    NVME_CMD_ADMIN_OPCODE_SECURITY_SEND = 0x81,
    NVME_CMD_ADMIN_OPCODE_SECURITY_RECEIVE,

    NVME_CMD_ADMIN_OPCODE_SANITIZE = 0x84,
    NVME_CMD_ADMIN_OPCODE_LOAD_PROGRAM,
    NVME_CMD_ADMIN_OPCODE_GET_LBA_STATUS,

    NVME_CMD_ADMIN_OPCODE_PROGRAM_ACTIVATION_MANAGEMENT = 0x88,
    NVME_CMD_ADMIN_OPCODE_MEM_RANGE_SET_MANAGEMENT
};
