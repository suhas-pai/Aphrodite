...
enum os_acpi_pptt_cache_type_node_attr_alloc_kind : uint8_t {
    ...
    OS_ACPI_PPTT_CACHE_TYPE_NODE_ATTR_ALLOC_KIND_WRITE,
    OS_ACPI_PPTT_CACHE_TYPE_NODE_ATTR_ALLOC_KIND_RDWR,
    OS_ACPI_PPTT_CACHE_TYPE_NODE_ATTR_ALLOC_KIND_RDWR_2,
};

enum os_acpi_pptt_cache_type_node_attr_cache_kind : uint8_t {
    OS_ACPI_PPTT_CACHE_TYPE_NODE_ATTR_CACHE_KIND_DATA,
    OS_ACPI_PPTT_CACHE_TYPE_NODE_ATTR_CACHE_KIND_INSTR,
