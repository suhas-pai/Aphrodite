...
enum acpi_driver_resources_flags : uint16_t {
    OS_ACPI_DRIVER_RESOURCES_IO = 1 << 0,
    OS_ACPI_DRIVER_RESOURCES_MEM = 1 << 1,
    OS_ACPI_DRIVER_RESOURCES_IRQ = 1 << 2,
    OS_ACPI_DRIVER_RESOURCES_DMA = 1 << 3,
    OS_ACPI_DRIVER_RESOURCES_ADDR = 1 << 4,
    OS_ACPI_DRIVER_RESOURCES_DEP = 1 << 5,
    OS_ACPI_DRIVER_RESOURCES_VENDOR = 1 << 6,
    OS_ACPI_DRIVER_RESOURCES_REG = 1 << 7,
    OS_ACPI_DRIVER_RESOURCES_GPIO = 1 << 8,

    OS_ACPI_DRIVER_RESOURCES_ALL =
        OS_ACPI_DRIVER_RESOURCES_IO |
        OS_ACPI_DRIVER_RESOURCES_MEM |
        OS_ACPI_DRIVER_RESOURCES_IRQ |
        OS_ACPI_DRIVER_RESOURCES_DMA |
        OS_ACPI_DRIVER_RESOURCES_ADDR |
        OS_ACPI_DRIVER_RESOURCES_DEP |
        OS_ACPI_DRIVER_RESOURCES_VENDOR |
        OS_ACPI_DRIVER_RESOURCES_REG |
        OS_ACPI_DRIVER_RESOURCES_GPIO,
};
