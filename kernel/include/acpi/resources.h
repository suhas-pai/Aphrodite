...
enum acpi_driver_resources_flags : uint16_t {
    __OS_ACPI_DRIVER_RESOURCES_IO = 1 << 0,
    __OS_ACPI_DRIVER_RESOURCES_MEM = 1 << 1,
    __OS_ACPI_DRIVER_RESOURCES_IRQ = 1 << 2,
    __OS_ACPI_DRIVER_RESOURCES_DMA = 1 << 3,
    __OS_ACPI_DRIVER_RESOURCES_ADDR = 1 << 4,
    __OS_ACPI_DRIVER_RESOURCES_DEP = 1 << 5,
    __OS_ACPI_DRIVER_RESOURCES_VENDOR = 1 << 6,
    __OS_ACPI_DRIVER_RESOURCES_REG = 1 << 7,
    __OS_ACPI_DRIVER_RESOURCES_GPIO = 1 << 8,

    __OS_ACPI_DRIVER_RESOURCES_ALL =
        __OS_ACPI_DRIVER_RESOURCES_IO |
        __OS_ACPI_DRIVER_RESOURCES_MEM |
        __OS_ACPI_DRIVER_RESOURCES_IRQ |
        __OS_ACPI_DRIVER_RESOURCES_DMA |
        __OS_ACPI_DRIVER_RESOURCES_ADDR |
        __OS_ACPI_DRIVER_RESOURCES_DEP |
        __OS_ACPI_DRIVER_RESOURCES_VENDOR |
        __OS_ACPI_DRIVER_RESOURCES_REG |
        __OS_ACPI_DRIVER_RESOURCES_GPIO,
};
