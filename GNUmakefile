...
.PHONY: kernel
kernel: kernel-deps
	$(MAKE) -C kernel DEBUG=$(DEBUG) DISABLE_FLANTERM=$(DISABLE_FLANTERM) DEBUG_LOCKS=$(DEBUG_LOCKS) CHECK_SLABS_=$(CHECK_SLABS) CONFIG_16K_PAGES=$(CONFIG_16K_PAGES) CONFIG_UACPI=$(CONFIG_UACPI)
