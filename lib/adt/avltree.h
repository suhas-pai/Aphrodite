...
typedef bool
(*avltree_traverse_callback_t)(struct avltree *tree,
                               struct avlnode *node,
                               void *cb_info);

bool
avltree_node_preorder(struct avltree *tree,
                      struct avlnode *node,
                      avltree_traverse_callback_t callback,
                      void *cb_info);
bool
avltree_node_inorder(struct avltree *tree,
                     struct avlnode *node,
                     avltree_traverse_callback_t callback,
                     void *cb_info);

bool
avltree_node_postorder(struct avltree *tree,
                       struct avlnode *node,
                       avltree_traverse_callback_t callback,
                       void *cb_info);
...
typedef int
(*avlnode_compare_t)(struct avlnode *ours,
                     struct avlnode *theirs,
                     void *cb_info);

typedef int
(*avlnode_compare_key_t)(struct avlnode *theirs, void *key, void *cb_info);

typedef void (*avltree_node_moved_t)(struct avlnode *node, void *cb_info);
typedef void (*avltree_node_added_t)(struct avlnode *node, void *cb_info);

void avlnode_merge(struct avlnode *left, struct avlnode *right);
bool avltree_empty(const struct avltree *tree);

bool
avltree_insert(struct avltree *tree,
               struct avlnode *node,
               avlnode_compare_t comparator,
               avltree_node_moved_t moved,
               avltree_node_added_t added_node,
               void *cb_info);
...
struct avlnode *
avltree_find(struct avltree *tree,
             void *key,
             avlnode_compare_key_t comparator,
             void *cb_info);
