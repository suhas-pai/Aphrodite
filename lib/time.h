...
#define fsec_to_psec(fsec) femto_to_pico(fsec)
#define fsec_to_nsec(fsec) femto_to_nano(fsec)
#define fsec_to_usec(fsec) femto_to_micro(fsec)
#define fsec_to_msec(fsec) femto_to_milli(fsec)
#define fsec_to_sec(fsec) femto_to_seconds(fsec)
#define fsec_to_min(fsec) femto_to_minutes(fsec)
#define fsec_to_hour(fsec) femto_to_hours(fsec)
#define fsec_to_day(fsec) femto_to_days(fsec)

#define psec_to_fsec(psec) pico_to_femto(psec)
#define psec_to_nsec(psec) pico_to_nano(psec)
#define psec_to_usec(psec) pico_to_micro(psec)
#define psec_to_msec(psec) pico_to_milli(psec)
#define psec_to_sec(psec) pico_to_seconds(psec)
#define psec_to_min(psec) pico_to_minutes(psec)
#define psec_to_hour(psec) pico_to_hours(psec)
#define psec_to_day(psec) pico_to_days(psec)

#define nsec_to_fsec(nsec) nano_to_femto(nsec)
#define nsec_to_psec(nsec) nano_to_pico(nsec)
#define nsec_to_usec(nsec) nano_to_micro(nsec)
#define nsec_to_msec(nsec) nano_to_milli(nsec)
#define nsec_to_sec(nsec) nano_to_seconds(nsec)
#define nsec_to_min(nsec) nano_to_minutes(nsec)
#define nsec_to_hour(nsec) nano_to_hours(nsec)
#define nsec_to_day(nsec) nano_to_days(nsec)

#define usec_to_fsec(usec) micro_to_femto(usec)
#define usec_to_psec(usec) micro_to_pico(usec)
#define usec_to_nsec(usec) micro_to_nano(usec)
#define usec_to_msec(usec) micro_to_milli(usec)
#define usec_to_sec(usec) micro_to_seconds(usec)
#define usec_to_min(usec) micro_to_minutes(usec)
#define usec_to_hour(usec) micro_to_hours(usec)
#define usec_to_day(usec) micro_to_days(usec)

#define msec_to_fsec(msec) milli_to_femto(msec)
#define msec_to_psec(msec) milli_to_pico(msec)
#define msec_to_nsec(msec) milli_to_nano(msec)
#define msec_to_usec(msec) milli_to_micro(msec)
#define msec_to_sec(msec) milli_to_seconds(msec)
#define msec_to_min(msec) milli_to_minutes(msec)
#define msec_to_hour(msec) milli_to_hours(msec)
#define msec_to_day(msec) milli_to_days(msec)

#define sec_to_fsec(sec) seconds_to_femto(sec)
#define sec_to_psec(sec) seconds_to_pico(sec)
#define sec_to_nsec(sec) seconds_to_nano(sec)
#define sec_to_usec(sec) seconds_to_micro(sec)
#define sec_to_msec(sec) seconds_to_milli(sec)
#define sec_to_min(sec) seconds_to_minutes(sec)
#define sec_to_hour(sec) seconds_to_hours(sec)
#define sec_to_day(sec) seconds_to_days(sec)

#define min_to_fsec(min) minutes_to_femto(min)
#define min_to_psec(min) minutes_to_pico(min)
#define min_to_nsec(min) minutes_to_nano(min)
#define min_to_usec(min) minutes_to_micro(min)
#define min_to_msec(min) minutes_to_milli(min)
#define min_to_sec(min) minutes_to_seconds(min)
#define min_to_hour(min) minutes_to_hours(min)
#define min_to_day(min) minutes_to_days(min)

#define hour_to_fsec(hour) hours_to_femto(hour)
#define hour_to_psec(hour) hours_to_pico(hour)
#define hour_to_nsec(hour) hours_to_nano(hour)
#define hour_to_usec(hour) hours_to_micro(hour)
#define hour_to_msec(hour) hours_to_milli(hour)
#define hour_to_sec(hour) hours_to_seconds(hour)
#define hour_to_min(hour) hours_to_minutes(hour)
#define hour_to_day(hour) hours_to_days(hour)

#define day_to_fsec(day) days_to_femto(day)
#define day_to_psec(day) days_to_pico(day)
#define day_to_nsec(day) days_to_nano(day)
#define day_to_usec(day) days_to_micro(day)
#define day_to_msec(day) days_to_milli(day)
#define day_to_sec(day) days_to_seconds(day)
#define day_to_min(day) days_to_minutes(day)
#define day_to_hour(day) days_to_hours(day)
...
#endif /* !defined(__timespec_defined) && !defined(_STRUCT_TIMESPEC) */
